...
| [TotpSecretField](docs/TotpLogin.md) | ユーザーモジュールに置くと ID/パスワードのログインが二要素認証 (TOTP) 付きになる宣言フィールド (秘密鍵列 3 つを書き込み専用で名指し。サーバ側は Extras.Server の TotpLogin) |
...
- [TotpSecretField / 二要素認証 (TOTP)](docs/TotpLogin.md)
