...
{
    public class FileColumnMappingTransformTest
    {
        ...
        public async Task ToExternalFormatsByFieldSettings()
        {
            ...
            var result = await FileColumnMappingTransform.ToExternalAsync(items, design, CreateModule(), NoTableTexts);
        ...
        public async Task ToInternalReportsFormatMismatchWithRowNumber()
        {
            ...
            var (_, errors) = await FileColumnMappingTransform.ToInternalAsync(externalTexts, design, CreateModule(), NoTableTexts);
