...
本人の Gmail (担当者個人のアカウント) から送る用途は、トークンを各自の PC にだけ置く Windows アプリ [MailSender](MailSender.md) が担います (サーバーにはトークンを置かない)。
...
- 本人の Gmail (担当者個人のアカウント) から送る用途は、トークンを各自の PC にだけ置く Windows アプリ **MailSender** が担います (サーバーにはトークンを置かない)
